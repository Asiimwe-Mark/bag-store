      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight fade-up stagger-1 hero-title">
              Luxury Handbags<br />for <span className="brand-red">Elegant</span><br />Women
            </h1>

            <p className="text-base sm:text-lg text-matte-700 max-w-lg leading-relaxed fade-up stagger-2 hero-subtitle">
              Premium fashion. Affordable luxury. Discover 50+ handcrafted bags designed for the modern woman in Uganda & East Africa.
            </p>

            <div className="fade-up stagger-2 border-l-4 border-brand-red pl-4 sm:pl-6">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2 fade-up stagger-4">
          ...
          <div className="hidden lg:flex justify-center items-center relative">
            <div className="relative w-80 sm:w-96 h-[400px] sm:h-[500px]">
              ...
              <img 
                src="https://picsum.photos/seed/lorahproduct/400/500" 
                alt="Premium Handbag" 
