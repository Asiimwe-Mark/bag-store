      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          <div className="relative fade-left">
            ...
            <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 glass rounded-xl sm:rounded-2xl p-3 sm:p-4">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-2 sm:pt-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start gap-3">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-champagne-100 rounded-xl flex items-center justify-center flex-shrink-0">
